...
public final class TintHelper {
    ...
    public static void setTint(
            @NonNull SwitchMaterial switchView, @ColorInt int color, boolean useDarker) {
        if (switchView.getTrackDrawable() != null) {
            switchView.setTrackTintList(
                    createSwitchDrawableTintList(
                            switchView.getContext(), color, false, true, useDarker));
        }
        if (switchView.getThumbDrawable() != null) {
            switchView.setThumbTintList(
                    createSwitchDrawableTintList(
                            switchView.getContext(), color, true, true, useDarker));
        }
    }

    public static void setTintAuto(
            final @NonNull View view, final @ColorInt int color, boolean background) {
        setTintAuto(
                view,
                color,
                background,
                ATHUtil.INSTANCE.isWindowBackgroundDark(view.getContext()));
    }
    ...
    public static void setTintSelector(
            @NonNull View view,
        ...
        final int disabled =
                ContextCompat.getColor(
                        view.getContext(),
                        useDarkTheme
                                ? R.color.ate_button_disabled_dark
                                : R.color.ate_button_disabled_light);
        ...
        final int textColor =
                ContextCompat.getColor(
                        view.getContext(),
                        isColorLight
                                ? R.color.ate_primary_text_light
                                : R.color.ate_primary_text_dark);
    ...
    private static int getDefaultRippleColor(@NonNull Context context, boolean useDarkRipple) {
        ...
        return ContextCompat.getColor(
                context,
                useDarkRipple ? R.color.ripple_material_light : R.color.ripple_material_dark);
    }
    ...
    private static ColorStateList createSwitchDrawableTintList(
    ...
    private static Drawable modifySwitchDrawable(
        ...
        ColorStateList sl =
                createSwitchDrawableTintList(context, tint, thumb, compatSwitch, useDarker);
        return createTintedDrawable(from, sl);
    }

    private static void setTint(
            final FloatingActionButton view, final int color, final boolean isDark) {
