...
import com.mcgrady.xproject.module_samples.databinding.ActivityShapeSampleBinding
...
class ShapeActivity : BaseActivity() {
    ...
    override fun initView(savedInstanceState: Bundle?) {
        ...
        binding.btnChangeShapeSoild.setOnClickListener {
            ...
            drawable.color = ContextCompat.getColorStateList(this, R.color.design_default_color_error)
        }
    }
