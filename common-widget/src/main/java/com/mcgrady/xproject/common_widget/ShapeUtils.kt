package com.mcgrady.xproject.common_widget
...
object ShapeUtils {
    ...
    fun roundedRect(
            left: Float, top: Float, right: Float, bottom: Float, _rx: Float, _ry: Float,
    ...
    fun roundedRect(
            ...
            _tl: Float, _tr: Float, _br: Float, _bl: Float): Path {
        var tl = _tl
        var tr = _tr
        var br = _br
        var bl = _bl
