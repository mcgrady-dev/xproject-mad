package com.mcgrady.xproject.common_widget.progress_circular_view
...
import com.mcgrady.xproject.common_widget.R
import com.mcgrady.xproject.common_widget.UIUtils
import com.mcgrady.xproject.common_widget.progress_circular_view.animation.AnimationDrawingState
import com.mcgrady.xproject.common_widget.progress_circular_view.animation.DefaultAnimationOrchestrator
import com.mcgrady.xproject.common_widget.progress_circular_view.animation.IAnimatorInterface
import com.mcgrady.xproject.common_widget.progress_circular_view.animation.ViewAnimationOrchestrator
...
//        }
    ...
    init {
        ...
        defaultSize = UIUtils.dp2px(150.toFloat())
    ...
    private fun initOutRingAttrs(a: TypedArray) {
        ...
        outRingBgColor =
            a.getColor(R.styleable.ProgressCircularView_cv_outring_bg_color, Color.parseColor("#33000000"))
    ...
    private fun initBadgeAttrs(a: TypedArray) {
        ...
        badgeColor = a.getColor(R.styleable.ProgressCircularView_cv_badge_color, Color.parseColor("#66000000"))
//        badgeStrokeColor =
//            a.getColor(R.styleable.CourseView_cv_badge_stroke_color, Defaults.BADGE_STROKE_COLOR)
        ...
        badgeTextPaint.textSize =
            a.getDimension(R.styleable.ProgressCircularView_cv_badge_text_size, initialsPaint.textSize)
    ...
    private fun startAnimator(start: Float, end: Float, animTime: Int?) {
        ...
        animator?.apply {
            ...
            addUpdateListener { animation ->
                ...
                Log.d("onAnimationUpdate", "percent = $percent progressCurrentValue = $progressCurValue progressMaxValue = $progressMaxValue")
                invalidate()
            }
            start()
        }
