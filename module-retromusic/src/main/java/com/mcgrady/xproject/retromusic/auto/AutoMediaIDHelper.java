 ...
 */
package com.mcgrady.xproject.retromusic.auto;
...
public class AutoMediaIDHelper {
     ...
     *
     * <p>Encode the media browseable categories, if any, and the unique music ID, if any, into a
     * single String mediaID.
     *
     * <p>MediaIDs are of the form <categoryType>__/__<categoryValue>__|__<musicUniqueId>, to make
     * it easy to find the category (like genre) that a music was selected from, so we can correctly
     * build the playing queue. This is specially useful when one music can appear in more than one
